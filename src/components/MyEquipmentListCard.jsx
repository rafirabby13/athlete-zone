...
const MyEquipmentListCard = ({ myEquipments, handleDelete }) => {
  ...
  return (
    <div>
      ...
      <div className="relative bg-white myEquipment shadow-md rounded-lg overflow-hidden hover:shadow-lg hover:ring-2 hover:ring-[#439A97] flex flex-col justify-between h-full">
        ...
        <div className="relative">
          <img
            src={photo}
            alt={name}
            className="w-full h-28 md:h-32  transition-transform duration-300 hover:scale-105"
          />
        </div>

        <div className="p-1 md:p-3 flex flex-col gap-1">
          ...
          <div className=" flex justify-between items-center space-x-1 md:space-x-3">
            <Link
              ...
              className="w-full bg-[#439A97] text-white md:text-sm py-1  px-1 md:px-4 rounded-md shadow-md hover:bg-[#028d88] text-xs transition-transform duration-200 transform hover:scale-105 flex items-center justify-center"
            >
